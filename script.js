...
$(function () {
          ...
          onPostBody: function (data) {
            ...
            data.forEach(function (element) {
              if (store.has(element.uid)) {
                ++completedCount;
                $("tr[data-uniqueid='" + element.uid + "']").addClass(
                  highlight
                );
              }
            });
  ...
  const popOpts = {
    ...
    sanitize: false,
    content:
      'This will overwrite your current progress<div class="btn-group btn-group-sm" role="group" aria-label="Confirmation"><button type="button" class="btn btn-sm btn-success" id="popover-submit">Yes, do it</button><button type="button" class="btn btn-sm btn-danger" id="popover-cancel">No, get me out of here!</button></div>'
  };
