...
var defs = {
    ...
    "quests-blade-col":
    [{field:'name',title:'Name',sortable:true,filterControl:'input',filterStrictSearch:false},
    {field:'blade',title:'Blade',sortable:true,filterControl:'input',filterStrictSearch:false},
    {field:'location',title:'Location',sortable:true,filterControl:'input',filterStrictSearch:false},
    {field:'prereqs',title:'Prerequisites',sortable:false,filterControl:'input',filterStrictSearch:false},
    {field:'description',title:'Description',sortable:false}],
    "blades-fil": true,
    "blades-col":
    [{field:'blade',title:'Blade',sortable:true,filterControl:'input',filterStrictSearch:false},
    {field:'role',title:'Role',sortable:true,filterControl:'select',filterStrictSearch:true},
    {field:'stat',title:'Stat Modifier',sortable:true,filterControl:'input',filterStrictSearch:false},
    {field:'weapon',title:'Weapon',sortable:true,filterControl:'select',filterStrictSearch:true},
    {field:'element',title:'Element',sortable:true,filterControl:'select',filterStrictSearch: true},
    {field:'acquisition',title:'Acquisition',sortable:true,filterControl:'input',filterStrictSearch:false}],
    "shopdeeds-fil": true,
    "shopdeeds-col":
    ...
    "uniquemonsters-col":
    [{field:'name',title:'Name',sortable:true,filterControl:'input',filterStrictSearch:false},
    {field:'level',title:'Level',sortable:true,filterControl:'select',filterStrictSearch:true},
    {field:'species',title:'Species',sortable:true,filterControl:'input',filterStrictSearch:false},
    ...
    [{field:'name',title:'Name',sortable:true},
    {field:'location',title:'Location',sortable:true},
    {field:'mark',title:'Marker',sortable:true},
    {field:'description',title:'Description'}],
    "bspon-fil": false,
    "bspon-col":
    ...
    {field:'trust',title:'Trust',sortable:true},
    {field:'location',title:'Location',sortable:true},
    {field:'shop',title:'Shop',sortable:true},
    {field:'cost',title:'Cost (at Dev Lv.5)',sortable:true}]
};
